...
# Тест 2
# Обучение каскада из 5-х пакетов: 2000-2000-2000-2000-2000-1 на 30 эпохах
...
batch = 8000      # размер батча
epoh = 30         # количество эпох
func = "class"    # задача - классификация

alpha = 20000    # коэффициент "мягкости" решения уравнений

# схема модели 
schema = [2000, 2000, 2000, 2000, 2000, 1]
