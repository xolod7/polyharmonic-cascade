...
# Тест 2
# Обучение каскада с 5-ю слоями 784-1000-1000-1000-1000-10 
# на 10 эпохах(закомментировано), на 100 эпохах(закомментировано), на 300 эпохах 
# с обычной настройкой (alpha = 200) (закомментировано)
# с медленной настройкой (alpha = 10000)
...
# alpha  = 200
alpha  = 10000    # коэффициент "мягкости" решения уравнений, значение 10000 значительно замедляет обучение

schema = [784, 1000, 1000, 1000, 1000, 10]  # схема каскада
